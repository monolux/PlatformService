package com.monolux.authorization.controllers;

import com.monolux.authorization.controllers.opened.BaseOpenedController;
...
@Slf4j
@Profile({"local", "dev"})
@RestControllerAdvice(basePackages = "com.monolux.authorization.controllers")
public class RestExceptionHandler extends BaseOpenedController {
    // region ▒▒▒▒▒ Handlers ▒▒▒▒▒
